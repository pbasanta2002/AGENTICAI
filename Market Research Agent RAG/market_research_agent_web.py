...
def web_search_duckduckgo(query, max_results=5):
    ...
    # with open('docs_retrieved_raw.txt','w', encoding="utf-8") as f:
    #     for doc in web_docs:
    #         f.write(doc)
    #         f.write('=====================================================================')
    # print("Downloaded web pages copied to file 'docs_retrieved_raw.txt'")
    return web_docs
...
iface = gr.Interface(
    ...
    outputs=gr.Textbox(label="Agent Response", lines=10, scale=1),
